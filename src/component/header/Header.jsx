        ...
        <div className="w-full max-w-[1260px] mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <div className="dropdown">
              ...
              <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                ...
                {user && <li><Link to="/myactivities">My Activities</Link></li>}
              </ul>
            </div>
          ...
          <div className="hidden lg:flex">
            <ul className="menu menu-horizontal px-1 gap-4">
              ...
              {user && <li><Link to="/myactivities" className="hover:text-primary">My Activities</Link></li>}
            </ul>
          </div>
                ...
                <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-[1]">
                  <li>
                    <Link to="/profile" className="justify-between">
                      Profile <span className="badge badge-sm">View</span>
                    </Link>
                  </li>
