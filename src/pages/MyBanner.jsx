      ...
      <div className="relative w-full h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-10 flex items-center justify-start h-full px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="text-left text-white max-w-5xl">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 mb-6 md:mb-8 text-xs sm:text-sm md:text-lg font-semibold">
            ...
            {/* Date Range */}
            <p className="text-xs sm:text-sm md:text-base text-gray-300 mb-6 md:mb-8 font-medium">
        ...
        {/* Dot Indicators */}
        <div className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 flex space-x-2 sm:space-x-3 z-20">
          {slides.map((_, index) => (
            <button
              key={index}
